...
function clickRight() {
  ...
  switch (newValue){
    case -270:
      ...
      document.querySelector('.project1-continer').setAttribute("aria-hidden",true);
      document.querySelector('.project4').removeAttribute("tabindex");
      document.querySelector('.project4-continer').removeAttribute("aria-hidden");
      break;
    case -540:
      document.querySelector('.project2').setAttribute("tabindex","-1");
      document.querySelector('.project2-continer').setAttribute("aria-hidden",true);
      document.querySelector('.project5').removeAttribute("tabindex");
      document.querySelector('.project5-continer').removeAttribute("aria-hidden");
    break;
    default:
      break;
  }
...
function clickLeft() {
  ...
  switch (newValue){
    case -270:
      ...
      document.querySelector('.project5-continer').setAttribute("aria-hidden",true);
      document.querySelector('.project2').removeAttribute("tabindex");
      document.querySelector('.project2-continer').removeAttribute("aria-hidden");
      break;
    case 0:
      document.querySelector('.project4').setAttribute("tabindex","-1");
      document.querySelector('.project4-continer').setAttribute("aria-hidden",true);
      document.querySelector('.project1').removeAttribute("tabindex");
      document.querySelector('.project1-continer').removeAttribute("aria-hidden");
    break;
    default:
      break;
  }
...
/*Escucha por la clve esq para cerra el model*/
function listenForEsc (e){
  if(e.keyCode===27) //27 en keycode.info == esc
  {
    closeModal(e);
  }
}
